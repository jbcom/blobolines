 ...
 * blue daylight sky bounce, and a soft cream rim.
...
export function Lighting() {
  return (
    <>
      ...
      <hemisphereLight intensity={1.1} color={palette.sky.top} groundColor={palette.sky.deep} />
      <directionalLight position={[6, 14, 8]} intensity={2.25} color={palette.sun} castShadow />
