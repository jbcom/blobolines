...
export function bodyLobes({
  ...
  return [
    ...
    {
      position: [
        dirX * radius * (0.78 + aimReach + excited * 0.12),
        radius * (0.14 + charge * 0.08 + aimLift * 0.38 + excited * 0.16 - burble * 0.5),
        dirZ * radius * (0.78 + aimReach + excited * 0.12),
      ],
      scale: [
        radius * (0.44 + charge * 0.18 + Math.min(aimH, 1) * charge * 0.14 + excited * 0.06),
