...
export const ROUTE_PROFILES: Record<WorldDifficulty, RouteDifficultyProfile> = {
  ready: {
    ...
    chargeTolerance: 0.55,
    chargeWeight: 0.18,
    minChargeFit: 0,
    minLipClearance: 1.4,
    minLipClearanceRatio: 0.38,
  ...
  blobmare: {
    ...
    chargeTolerance: 0.12,
    chargeWeight: 0.65,
    minChargeFit: 0,
    minLipClearance: 0.35,
  ...
  ultraBlobmare: {
    ...
    chargeTolerance: 0.07,
    chargeWeight: 0.78,
    minChargeFit: 0,
    minLipClearance: 0.18,
    minLipClearanceRatio: 0.06,
  ...
  oneWrongMove: {
    ...
    chargeTolerance: 0.035,
    chargeWeight: 0.92,
    minChargeFit: 0,
    minLipClearance: 0.08,
    minLipClearanceRatio: 0.03,
